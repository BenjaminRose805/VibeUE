...
> **DISABLED in this keyless fork.** `terrain_data` requires a vibeue.com cloud key, which this fork removes. Import your own heightmap instead (see the `landscape` skill).
